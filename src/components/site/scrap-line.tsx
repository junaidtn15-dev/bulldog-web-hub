...
export function ScrapLine() {
  ...
  return (
    <div ref={ref} className="grid gap-8 lg:grid-cols-[1.15fr_0.85fr] lg:items-center">
      <div className="glass ring-glow relative aspect-[16/10] overflow-hidden rounded-3xl">
        ...
        {/* car silhouette */}
        <svg viewBox="0 0 400 200" className="absolute inset-0 size-full p-8" aria-hidden>
          <defs>
      ...
      <div className="glass hover-lift rounded-3xl p-7">
        ...
        <p className="mt-3 font-display text-5xl font-extrabold tabular-nums text-chrome">
